...
- **Current Setting**: 0.55
    - If the confidence score for the model detecting a paste-over over the text field exceeds **0.55**, it indicates potential document spoofing. The recognition will be rejected with the status "Document liveness failed."
- **Recommended Setting**: Same as current setting.
